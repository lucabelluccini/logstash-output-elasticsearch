...
IMPORTANT: The plugin requires outbound connections to `tcp/443`, `tcp/9093`, `tcp/5671` and `tcp/5672` ([Microsoft Event Hub documentation](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-faq#what-ports-do-i-need-to-open-on-the-firewall)).
